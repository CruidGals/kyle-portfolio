...
const experiences = [
  {
    id: 1,
    title: 'HackPSU Tech Team',
    subtitle: 'Software Engineer / Techincal Organizer | Aug 2025 - Present',
    points: [
      "Contributed to full-stack Next.js (React, TypeScript) platform supporting 500+ participants during peak hours.",
      "Maintained and extended a unified NestJS API, modularizing endpoints for authentication, finance, and event services",
      "Prioritized mobile-first UI through Progressive Web App design, ensuring reliability under unstable WiFi conditions"
    ]
  },
  { id: 2, 
    title: 'The Pennsylvania State University', 
    subtitle: 'Research Intern - Robotics & Deep Learning | May 2025 - Sep 2025',
    points: [
